...
namespace iakademi43_proje.Models
{
    ...
    public partial class iakademi43DB_ProjeEntities : DbContext
    {
        public iakademi43DB_ProjeEntities()
            : base("name=iakademi43DB_ProjeEntities")
        {
        }
        ...
        public virtual DbSet<vw_siparislerim> vw_siparislerim { get; set; }
